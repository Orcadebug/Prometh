...
Prometh also provides native recursive delegation through `rlm.call()` and
...
- **Isolated context**: Each subagent runs in a separate Prometh process
...
This tool executes a separate Prometh subprocess with a delegated system prompt and tool/model configuration.
