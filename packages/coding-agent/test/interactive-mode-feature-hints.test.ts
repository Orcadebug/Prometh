...
describe("feature hint deck", () => {
	...
	it("covers Prometh workflows with capability-focused copy", () => {
		const deck = new FeatureHintDeck(() => 0);
		...
		expect(textById.get("subagents")).toBe("Prometh can delegate tasks to subagents and run them in parallel.");
