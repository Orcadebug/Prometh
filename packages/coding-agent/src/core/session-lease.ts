...
export const SESSION_LEASES_ENABLED_ENV = "PROMETH_INTERNAL_SESSION_LEASES";
export const SESSION_LEASE_OWNER_ID_ENV = "PROMETH_INTERNAL_SESSION_LEASE_OWNER_ID";
