...
const UPDATE_RESTART_MARKER =
	"<prometh_update_interrupted>\n" +
	"Prometh was updated and intentionally interrupted this session. Continue from the saved transcript and restored tool/kernel state. Any running model, tool, bash, or child-agent work may have been partially completed.\n" +
	"</prometh_update_interrupted>";
...
export class AgentDaemon {
	...
	async start(): Promise<void> {
		...
		this.log(`Prometh daemon listening on ${this.socketPath}`);
