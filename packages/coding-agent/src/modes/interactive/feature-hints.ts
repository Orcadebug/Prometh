...
export const FEATURE_HINTS: readonly FeatureHintDefinition[] = [
	...
	{
		id: "subagents",
		getText: () => "Prometh can delegate tasks to subagents and run them in parallel.",
	},
	{
		id: "agents-view",
	...
	},
	{
		...
		getText: () => "Prometh keeps IPython variables and helpers between turns and compactions.",
	},
	{
		id: "context-usage",
	...
	{
		id: "auto-compaction",
		getText: () => "Prometh automatically compacts long sessions before context fills up.",
	},
	{
		id: "auto-refine",
		getText: () => "Prometh self-improves by refining skills, memories, prompts, and subagents.",
	},
	{
