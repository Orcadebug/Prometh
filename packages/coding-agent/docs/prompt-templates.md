> Prometh can create prompt templates. Ask it to build one for your workflow.
...
Prometh loads prompt templates from:

- Global: `~/.prometh/prompts/*.md`
- Project: `.prometh/prompts/*.md`
