...
<h1 align="center">Prometh TUI</h1>
...
```typescript
import { TUI, Text, Editor, ProcessTerminal, matchesKey } from "prometh-tui";
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "prometh-tui";
...
```typescript
import { Container, type Focusable, Input } from "prometh-tui";
...
Renders Kitty or iTerm2 terminal graphics when supported. Set `fallbackOnly: true` to show compact image metadata instead; Prometh uses this metadata-only mode.
...
```typescript
import { CombinedAutocompleteProvider } from "prometh-tui";
...
```typescript
import { matchesKey, Key } from "prometh-tui";
...
```typescript
import { visibleWidth, truncateToWidth, wrapTextWithAnsi } from "prometh-tui";
...
```typescript
import { matchesKey, Key, truncateToWidth } from "prometh-tui";
import type { Component } from "prometh-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "prometh-tui";
import type { Component } from "prometh-tui";
